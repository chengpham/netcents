  ...
  describe "validates" do
    describe "_hash" do
      it "requires a _hash" do
        bitcoin = Bitcoin.create(_hash: "", total: 1232413, fees: 123)
        bitcoin.valid?
      ...
      it '_hash is unique' do
        ...
        bitcoin2 = Bitcoin.create(_hash: "32lkj23lk3", total: 1232413, fees: 123)
        bitcoin2.valid?
        expect(bitcoin2.errors.messages).to have_key(:_hash)
      end
    end
  end
end
